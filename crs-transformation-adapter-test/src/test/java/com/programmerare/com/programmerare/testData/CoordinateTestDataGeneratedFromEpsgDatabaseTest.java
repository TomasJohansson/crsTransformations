...
class CoordinateTestDataGeneratedFromEpsgDatabaseTest {
    ...
    void testAllTransformationsInGeneratedCsvFileWithGeoPackage() {
        ...
        handleTestResults(
            ...
            // file created: "test/resources/regression_results/CrsTransformationAdapterGeoPackageNGA_version_3.1.0.csv
        );
        // The above created latest output file "CrsTransformationAdapterGeoPackageNGA_version_3.1.0.csv"
