...
class CoordinateTestDataGeneratedFromEpsgDatabaseTest {
    ...
    void testAllTransformationsInGeneratedCsvFileWithGeoPackage() {
        ...
        handleTestResults(
            ...
            DELTA_LIMIT_FOR_SUCCESS,
            createNewRegressionFile,
            "_version_4.0.0" // build.gradle: 'mil.nga.geopackage:geopackage:4.0.0'
            // file created: "test/resources/regression_results/CrsTransformationAdapterGeoPackageNGA_version_4.0.0.csv
        );
        // The above created latest output file "CrsTransformationAdapterGeoPackageNGA_version_4.0.0.csv"
