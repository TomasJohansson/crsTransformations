...
class CoordinateTestDataGeneratedFromEpsgDatabaseTest {
    ...
    void testAllTransformationsInGeneratedCsvFileWithGeoTools() {
        ...
        handleTestResults(
            ...
            DELTA_LIMIT_FOR_SUCCESS,
            createNewRegressionFile,
            "_version_20.2"  // build.gradle: implementation("org.geotools:gt-main:20.2")
            // file created: "test/resources/regression_results/CrsTransformationAdapterGeoTools_version_20.2_.csv
        );
