...
# print sys.path # this includes '../ivy_dependencies/lib/gt-referencing-25.1.jar' which includes the class 'org.geotools.referencing.factory.epsg.CartesianAuthorityFactory' (mentioned further down because of problems with GeoTools)
...
class CrsTransformation:
    def main(self):
        ...
        for result in crsTransformationResults:
            ...
            # but the above mentioned class 'CartesianAuthorityFactory' is located in the jar file 'gt-referencing-25.1.jar' 
        ...
        for leaf in CrsTransformationAdapterLeafFactory.getInstancesOfAllKnownAvailableImplementations():
            ...
            #   LEAF_PROJ4J_LOCATIONTECH 1.1.3  : X / Y ===> 674032.357326 / 6580821.99112
            #   LEAF_NGA_GEOINT 4.0.0  : X / Y ===> 674032.357326 / 6580821.99112
