...
enum class CrsTransformationAdapteeType {
     ...
     * @since 1.0.0
     */
    @Deprecated("Use 'LEAF_NGA_GEOPACKAGE_5_0_0' instead since the currently used 'mil.nga.geopackage' library is version 5.0.0")
    ...
    /**
     * Maven version for the adaptee library:
     * "mil.nga.geopackage:geopackage-core:5.0.0"
     * @since the next version after 1.1.1
     */
    LEAF_NGA_GEOPACKAGE_5_0_0,    
